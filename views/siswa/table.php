...
<style>
    ...
    .badge-assigned  { background: var(--success-gradient) !important; color: white !important; font-size: .8em; }
    .badge-unassigned{ background: var(--warning-gradient) !important; color: black  !important; font-size: .8em; }
    ...
    .btn-sp:hover  { opacity: .88; transform: scale(1.06); }
    ...
    .user-card { border-left: 4px solid #10b981 !important; }
...
$(document).ready(function () {
    ...
    $.get('action_kelas.php?action=read')
        ...
        .fail(function () { showToast('❌ Gagal memuat kelas', 'error'); });
    ...
    $('#confirmSp').click(function () {
        ...
        $.post('action_siswa.php', { action: 'issue_sp', id: spSiswaId })
            .done(function (response) {
                if (response.success) {
                    $('#spModal').modal('hide');
                    siswaTable.ajax.reload();
